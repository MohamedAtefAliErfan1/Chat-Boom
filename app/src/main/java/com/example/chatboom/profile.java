...
public class profile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_profile);  final String user_id=getIntent().getStringExtra("user_id");
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if (dataSnapshot.hasChild(user_id)){
                            ...
                            if (req_stat.equals("received")){
                                ...
                                btnsendrequest.setBackgroundColor(getResources().getColor(R.color.design_default_color_primary));
                                btnreject.setBackgroundColor(getResources().getColor(R.color.common_google_signin_btn_text_light_pressed));
        ...
        btnsendrequest.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (current_stat.equals("friends")){
                    AlertDialog.Builder remove_friend=new AlertDialog.Builder(profile.this);
        ...
        btnreject.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder reject_req=new AlertDialog.Builder(profile.this);
